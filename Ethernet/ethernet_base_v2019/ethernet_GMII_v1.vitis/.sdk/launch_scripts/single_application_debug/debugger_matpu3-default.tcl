...
fpga -file /media/cliff/procom/elEther/repoTpf/ethernet_GMII_v1.vitis/matpu3/_ide/bitstream/eth1_wrapper2.bit
configparams mdm-detect-bscan-mask 2
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-SMT1 210203339927A"} -index 0
rst -system
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-SMT1 210203339927A"} -index 0
dow /media/cliff/procom/elEther/repoTpf/ethernet_GMII_v1.vitis/matpu3/Debug/matpu3.elf
bpadd -addr &main
