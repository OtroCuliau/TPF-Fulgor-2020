...
HD_PWD='/home/becario/ethernet/TPF-Fulgor-2020/Ethernet/ethernet_base_v2019/ethernet_GMII_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth1_wrapper.tcl
