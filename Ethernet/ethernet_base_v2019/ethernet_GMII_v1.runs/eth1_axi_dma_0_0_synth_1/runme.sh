...
HD_PWD='D:/dario/fulgor/trabajo_final/TPF-Fulgor-2020/Ethernet/ethernet_base_v2019/ethernet_GMII_v1.runs/eth1_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth1_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth1_axi_dma_0_0.tcl
