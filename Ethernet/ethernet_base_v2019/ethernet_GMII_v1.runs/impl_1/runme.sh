...
HD_PWD='D:/dario/fulgor/trabajo_final/TPF-Fulgor-2020/Ethernet/ethernet_base_v2019/ethernet_GMII_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth1_wrapper.tcl -notrace
