...
simulate()
{
  xsim eth1 -key {Behavioral:sim_1:Functional:eth1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_e73a.protoinst" -protoinst "protoinst_files/bd_d93c.protoinst" -protoinst "protoinst_files/bd_9386.protoinst" -protoinst "protoinst_files/eth1.protoinst" -log simulate.log
}
